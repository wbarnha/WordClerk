# WordClerk Terms of Use

**Last updated:** July 2026

These Terms of Use govern your use of WordClerk, a Microsoft Word add-in published and maintained
by William Barnhart ("**we**," "**us**," or "**the publisher**"). By installing or using WordClerk,
you agree to these terms. This document covers your rights and obligations in using the software;
for how WordClerk handles data, see the separate [Privacy Policy](PRIVACY.md).

## 1. Not legal advice

**WordClerk is a citation-formatting and hyperlinking tool, not a substitute for professional
...
professional work product.** WordClerk's checks are mechanical (regular-expression and database
...
## 2. License to use WordClerk

WordClerk is open-source software, licensed to you under the [MIT License](LICENSE). The MIT
License already grants you broad rights to use, copy, modify, and redistribute WordClerk; these
...
WordClerk is provided **"as is," without warranty of any kind, express or implied**, including but
not limited to the warranties of merchantability, fitness for a particular purpose, and
non-infringement, as stated in the [MIT License](LICENSE). The publisher does not warrant that
WordClerk will be error-free, uninterrupted, or that any citation-checking, hyperlinking, or
...
tort, or otherwise — arising from, out of, or in connection with WordClerk or the use or other
dealings in WordClerk, including but not limited to reliance on any citation, hyperlink,
...
- **Independent verification.** As stated in Section 1, you are responsible for independently
  verifying every result WordClerk produces before relying on it professionally.
- **Third-party credentials and services.** If you connect WordClerk to CourtListener, LexisNexis,
  ...
  secrets) you enter. WordClerk transmits those credentials only to the provider you're
  ...
  once received.
- **Compliance with your own organization's policies.** If you use WordClerk in a professional
...
WordClerk's opt-in lookup features connect to third-party services (CourtListener by default, or
enterprise providers you configure). Those services are operated independently of WordClerk and
governed by their own terms of service, not these Terms of Use. The publisher does not warrant the
availability, accuracy, or content of any third-party service WordClerk connects to.

## 7. Changes to WordClerk and these terms

WordClerk has no auto-update mechanism that reaches out to any publisher-controlled service —
...
project's [release notes](https://github.com/wbarnha/WordClerk/releases).
